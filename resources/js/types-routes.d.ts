...
declare namespace App.Route {
  ...
  export type Path = '/' | '/confirm-password' | '/dashboard' | '/email/verification-notification' | '/forgot-password' | '/login' | '/logout' | '/password' | '/profile' | '/question/{question}' | '/question/{question}/answer' | '/question/{question}/answer/{answer}' | '/register' | '/reset-password' | '/reset-password/{token}' | '/sanctum/csrf-cookie' | '/storage/{path}' | '/up' | '/verify-email' | '/verify-email/{id}/{hash}';
